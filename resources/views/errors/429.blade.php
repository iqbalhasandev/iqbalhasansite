<x-guest-layout>
    ...
    <div class="row pt-4 align-items-center justify-content-center">
        <div class="col-sm-5">
            <div class="">
                <img src="{{ admin_asset('images/errors/429.png') }}" alt="" class="img-fluid mx-auto d-block"
            ...
            <div class="text-center mb-5">
                ...
                <p class="px-2">
                    {{ $exception->getMessage() ?: 'Whoa, please slow down a bit soI can keep up with your requests.'}}
