            ...
            <div class="col-sm-12">
                <form enctype="multipart/form-data"
                    ...
                    <div class=" row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group pt-1 pb-1">
                                <label for="site" class="font-black">Client Site</label>
                                <input type="url" class="form-control" name="site" id="site" placeholder="Enter Url..."
                                    value="{{ isset($item)?$item->site:old('site') }}">
                                @error('site')
                                <p class="text-danger pt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group pt-1 pb-1">
                                <label for="logo" class="font-black">Client Logo</label>
                                <input type="file" class="form-control" name="logo" id="logo"
                                    onchange="get_img_url(this, '#logoUrl');">

                                <img id="logoUrl" src="{{ config('theme.cdata.edit')?$item->logo_url():'' }}"
