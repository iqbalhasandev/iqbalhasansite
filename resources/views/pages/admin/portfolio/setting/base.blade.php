<x-app-layout>
    ...
    <x-card class="container-fluid">
        <div class="row">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="panel-heading">
                                            ...
                                            <code class="badge badge-pill badge-info text-light"
                                                style="color: #ffffff!importent; font-family: sans-serif; padding: 6px; background: #373e3d;">portfolio_setting('{{ $setting->key }}')</code>
                                            <a href="javascript:void(0);" class="panel-action-btn clipboard"
                                                data-clipboard-text="portfolio_setting('{{ $setting->key }}')">
                                        ...
                                        <div class="panel-actions">
                                            <a href="{{ route('admin.portfolio.settings.moveUp',$setting->id) }}"
                                            ...
                                            <a href="{{ route('admin.portfolio.settings.moveDown',$setting->id) }}"
                                                class="panel-action-btn">
                                                <svg width="20px" enable-background="new 0 0 32 32" id="Слой_1"
                                                    version="1.1" viewBox="0 0 32 32" xml:space="preserve"
                                                    xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <a href="javascript: void(0);"
                                                onclick="delete_action('{{ route('admin.portfolio.settings.delete',$setting->id) }}')"
                                                class="panel-action-btn">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="mt-1 mb-2">
                                                    ...
                                                    <a
                                                        href="{{ route('admin.portfolio.settings.unsetValue',$setting->id) }}">
            ...
            <div class=" col-md-12">
                <div class="card-box">
                    <form action="{{ route('admin.portfolio.settings.store') }}" method="POST" class="needs-validation"
                        novalidate>
                        @csrf
                        <h3 class="h3">
                            Create Portfolio Setting New
                        </h3>
                        <hr>
